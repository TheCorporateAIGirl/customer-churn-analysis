...
![Main Insight - Churn by Contract](Churn Analysis Contract Type)
...
![Confusion Matrix](Churn Analysis Confusion Martix)
...
![SHAP Summary Plot](SHAP  Value for Churn Analysis)
